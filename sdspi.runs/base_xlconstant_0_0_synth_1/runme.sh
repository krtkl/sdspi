...
HD_PWD='Z:/Software/sdspi/sdspi.runs/base_xlconstant_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_xlconstant_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_xlconstant_0_0.tcl
